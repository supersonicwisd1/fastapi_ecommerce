...
from tortoise.contrib.pydantic import pydantic_model_creator as _pmc
...
class Product(Model):
    ...
    offer_expiraton_date = fields.DateField(default=datetime.utcnow)
...
user_pydantic = _pmc(User, name = "User", exclude=("is_verified", ))
user_pydanticIn = _pmc(User, name = "UserIn", exclude_readonly=True, exclude=("is_verified", 'join_date'))
user_pydanticOut = _pmc(User, name = "UserOut", exclude=("password", ))

business_pydantic = _pmc(Business, name = "Business")
business_pydanticIn = _pmc(Business, name = "Business", exclude=('logo', 'id'))

product_pydantic = _pmc(Product, name="Product")
product_pydanticIn = _pmc(Product, name="ProductIn", exclude=("percentage_discount", "id", "product_image", 'date_published'))